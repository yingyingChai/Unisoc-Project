...
namespace AMSServicesTest
{
    ...
    public partial class USERS
    {
        ...
        public Nullable<int> NewComments { get; set; }
        public Nullable<int> WaitForDispose { get; set; }
        public Nullable<int> WaitForConfirm { get; set; }
        public Nullable<int> WaitForOtherBinDispose { get; set; }
        public Nullable<int> EQALots { get; set; }
