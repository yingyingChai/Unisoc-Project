namespace Spreadtrum.LHD.DAL.Lots
{
    ...
    public class NotificationswithLotGateway
    {
        private DALGateway<NotificationswithLot> dbGateway = new DALGateway<NotificationswithLot>();

        public NotificationswithLotGateway()
        {
            this.dbGateway.LoadSchema("VW_NOTIFICATIONSWITHLOTS");
        }
