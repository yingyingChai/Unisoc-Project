namespace Spreadtrum.LHD.Mvc.Areas.Users.Controllers
{
    ...
    public class UserManagerController : BaseController
    {
        ...
        public ActionResult DisplayUsersByRole(int pageSize, int pageIndex, string hidCurrentRole)
        {
            int recordCount = 0;
            ...
            IList<User> list = UserService.GetUsersBy(base.Request.QueryString["txtFullName"], email, role, accountState, pageIndex, pageSize, out recordCount);
