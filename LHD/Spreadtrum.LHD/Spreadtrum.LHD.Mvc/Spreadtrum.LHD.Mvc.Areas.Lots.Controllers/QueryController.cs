namespace Spreadtrum.LHD.Mvc.Areas.Lots.Controllers
{
    ...
    public class QueryController : BaseController
    {
        ...
        public ActionResult mLotDispose(int pageIndex = 0, int pageSize = 10)
        {
            return base.View("mIndex");
        }
        ...
        public ActionResult mNewComment(int pageIndex = 0, int pageSize = 10)
        {
            return base.View("mIndex");
        }
        ...
        public ActionResult mOtherBinDispose(int pageIndex = 0, int pageSize = 10)
        {
            return base.View("mIndex");
        }
