    ...
    public class MimeEntity
    {
        ...
        private void BuildMultiPartMessage(MimeEntity entity, MailMessageEx message)
        {
            foreach (MimeEntity child in entity.Children)
            {
                ...
                else if (child.ContentType != null && child.ContentDisposition != null  //added by  zeng 2011.01.17
                    && string.Equals(child.ContentType.MediaType, MediaTypes.MessageRfc822, StringComparison.InvariantCultureIgnoreCase)
