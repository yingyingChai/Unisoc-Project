namespace Spreadtrum.LHD.DAL.Users
{
    ...
    public class UserGateway
    {
        ...
        public IList<User> GetUsersBy(string keyword, string email, string role, string accountState, int pageIndex, int pageSize, out int recordCount)
        {
            Conditions conditions = new Conditions();
        ...
        public IList<User> GetUsersByRole(UserRoles role, int pageIndex, int pageSize, out int recordCount)
        {
            Conditions conditions = new Conditions();
            switch (role)
            {
